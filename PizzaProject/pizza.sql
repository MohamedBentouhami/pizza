DROP TABLE IF EXISTS pizzacommandegarniture;
DROP TABLE IF EXISTS pizzacommande;
DROP TABLE IF EXISTS commande;
DROP TABLE IF EXISTS contient;
DROP TABLE IF EXISTS pizza;
DROP TABLE IF EXISTS garniture;
...
ALTER TABLE contient ADD CONSTRAINT 
	fk_contient_pizza foreign key(cPizza) REFERENCES pizza (pId);

ALTER TABLE contient ADD CONSTRAINT 
	fk_contient_gar foreign key(cGar) REFERENCES garniture (gId);
...
ALTER TABLE commande ADD CONSTRAINT 
	fk_commande_client foreign key(comClient) REFERENCES client (cliId);
...
ALTER TABLE pizzacommande ADD CONSTRAINT 
	fk_pizzacommande_commande foreign key(pcNumCom) REFERENCES commande (comId);
...
ALTER TABLE pizzacommandegarniture ADD CONSTRAINT 
	fk_pizcomgar_garniture foreign key(pcgGar) REFERENCES garniture (gId);
